...
<div class="main">
  <div class="content-top">
    ...
    <ul id="flexiselDemo3">
      <li><img src="<?= base_url('') ?>images/board1.jpg" /></li>
      <li><img src="<?= base_url('') ?>images/board2.jpg" /></li>
      <li><img src="<?= base_url('') ?>images/board3.jpg" /></li>
      <li><img src="<?= base_url('') ?>images/board4.jpg" /></li>
      <li><img src="<?= base_url('') ?>images/board5.jpg" /></li>
    </ul>
  ...
  <div class="container">
    <div class="row content_bottom-text">
      <div class="col-md-7">
        ...
        <p class="m_2">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod
          tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci
          tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure
          dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis
          at vero eros et accumsan et iusto odio.</p>
    ...
    <div class="row">
      <div class="col-md-3 top_box">
        <div class="view view-ninth"><a href="single.html">
            <img src="<?= base_url('') ?>images/pic1.jpg" class="img-responsive" alt="" />
      ...
      <div class="col-md-3 top_box">
        <div class="view view-ninth"><a href="single.html">
            <img src="<?= base_url('') ?>images/pic2.jpg" class="img-responsive" alt="" />
            <div class="mask mask-1"> </div>
            <div class="mask mask-2"> </div>
            <div class="content">
              <h2>Hover Style #9</h2>
      ...
      <div class="col-md-3 top_box">
        <div class="view view-ninth"><a href="single.html">
            <img src="<?= base_url('') ?>images/pic3.jpg" class="img-responsive" alt="" />
            <div class="mask mask-1"> </div>
            <div class="mask mask-2"> </div>
            <div class="content">
              <h2>Hover Style #9</h2>
      ...
      <div class="col-md-3 top_box1">
        <div class="view view-ninth"><a href="single.html">
            <img src="<?= base_url('') ?>images/pic4.jpg" class="img-responsive" alt="" />
            <div class="mask mask-1"> </div>
            <div class="mask mask-2"> </div>
            <div class="content">
              <h2>Hover Style #9</h2>
